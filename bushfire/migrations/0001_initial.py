    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bushfire', models.ForeignKey(related_name='comments', to='bushfire.Bushfire')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bushfire', models.OneToOneField(to='bushfire.Bushfire')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bushfire', models.ForeignKey(related_name='effect', to='bushfire.Bushfire')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('bushfire', models.ForeignKey(related_name='first_attack', to='bushfire.Bushfire')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bushfire', models.ForeignKey(related_name='location', to='bushfire.Bushfire')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fd_number', models.PositiveSmallIntegerField(null=True, verbose_name=b'FD Number', blank=True)),
                ('fd_tenths', models.CharField(max_length=2, null=True, verbose_name=b'FD Tenths', blank=True)),
                ('bushfire', models.ForeignKey(related_name='origin', to='bushfire.Bushfire')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bushfire', models.ForeignKey(related_name='reporting', to='bushfire.Bushfire')),
                ('cause', models.ForeignKey(to='bushfire.Cause')),
        ...
        migrations.AddField(
            ...
            name='bushfire',
            field=models.ForeignKey(related_name='authorisation', to='bushfire.Bushfire'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='authorisation',
