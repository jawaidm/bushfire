    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fesa_incident_no', models.CharField(max_length=10, verbose_name=b'FESA Incident No.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=50, verbose_name=b'Name/Description')),
        ...
        migrations.CreateModel(
            name='InitialAuthorisation',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('created', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('creator', models.ForeignKey(related_name='bushfire_initialauthorisation_created', editable=False, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cause', models.ForeignKey(to='bushfire.Cause')),
                ('first_attack', models.ForeignKey(to='bushfire.Agency')),
                ('fuel_type', models.ForeignKey(to='bushfire.FuelType')),
                ('initial_bushfire', models.OneToOneField(related_name='initial_detail', to='bushfire.InitialBushfire')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.OneToOneField(verbose_name=b'Direction', to='bushfire.Direction')),
        ...
        migrations.AddField(
            model_name='initialauthorisation',
        ...
        migrations.AddField(
            model_name='initialauthorisation',
            name='modifier',
            field=models.ForeignKey(related_name='bushfire_initialauthorisation_modified', editable=False, to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='initialauthorisation',
        ...
        migrations.AddField(
            model_name='effect',
            name='effect',
            field=models.ForeignKey(verbose_name=b'FRB Effect', to='bushfire.FrbEffect'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='district',
        ...
        migrations.AddField(
            ...
            name='bushfire',
            field=models.OneToOneField(related_name='authorisation', to='bushfire.Bushfire'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='authorisation',
